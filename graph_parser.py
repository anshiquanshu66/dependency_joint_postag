...
def main():
    ...
    args_parser.add_argument('--mode', default='FastLSTM', choices=['LSTM', 'RNN', 'GRU', 'FastLSTM'])
    ...
    args_parser.add_argument('--char_dim', type=int, default=100)
    ...
    args_parser.add_argument('--train', default='./data/ud-treebanks-v2.2/UD_Vietnamese-VTB/vi_vtb-ud-train.conllu')
    args_parser.add_argument('--dev', default='./data/ud-treebanks-v2.2/UD_Vietnamese-VTB/vi_vtb-ud-dev.conllu')
    args_parser.add_argument('--test', default='./data/ud-treebanks-v2.2/UD_Vietnamese-VTB/vi_vtb-ud-test.conllu')
    args_parser.add_argument('--model_path', default='./results/biaffine/')
